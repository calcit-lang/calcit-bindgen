...
- CI 固定到已合并的 Calcit Struct fixture commit，确保上游 contract/core 配对可复现。
...
- Pin CI to the merged Calcit Struct fixture commit so the upstream contract/core pair remains reproducible.
